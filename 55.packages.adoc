...
任何包都可以有一个 link:https://docs.perl6.org/type/Version[Version] 对象。 这个对象可以通过 `$PACKAGE.^ver` 或从包 `Fully::Qualified::Name.^ver` 外部访问。

link:https://docs.perl6.org/language/packages[Packages]
